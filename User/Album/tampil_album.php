    ...
    <div class="row">
        ...
        <div class="col-sm-4" style="padding:10px;">
            <div class="card" style="width: 28rem;">
                ...
                <img src="../Assets/image/foto/tambah2.png" title="Menambah Album" width="90%" height="90%" class="card-img-top" alt="Tambah Foto">
                </a>
                <div class="card-body">
        ...
        <?php
            while ($data = $sql->fetch()) {
                ...
                <div class="col-sm-4" style="padding:10px;">
                    <div class="card" style="width: 28rem;">
                        <a href="?page=foto&aksi=tampil_foto&id=<?php echo $data['albumid'] ?>" onClick="">
                        <?php
