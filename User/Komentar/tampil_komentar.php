<?php
    $queryfoto = "SELECT * FROM tbl_foto ORDER BY tanggalunggah DESC";
        ...
        <div class="box box-widget">
          ...
          <div class='box-body'>
            ...
            <?php
                ...
                if ($jmllike == 0) {
                     ?>
                     <a href="?page=komentar&aksi=like_foto&id=<?php echo $data['fotoid']; ?>&status=like" class='btn btn-default btn-xs' title="Anda Menyukai Foto"><i class='fa fa-thumbs-o-up'> Like</i></a>
                     <?php
                } else {
                     ?>
                     <a href="?page=komentar&aksi=like_foto&id=<?php echo $data['fotoid']; ?>&status=unlike" class='btn btn-default btn-xs' title="Anda Tidak Menyukai Foto"><i class='fa fa-thumbs-o-down'></i> Unlike</a>
                     <?php
                }
            ...
            <div class='box-comment'>
              ...
              <div class='comment-text'>
                ...
                <span class='text-muted pull-right'>
                    <?php 
                      echo $datakomentar['tanggalkomentar'];
                      
                      if ($user == $datakomentar['userid']) {
                        ?>
                        <a href="?page=komentar&aksi=hapus_komentar&id=<?php echo $datakomentar['komentarid'] ?>" class='btn btn-box-tool' onclick="return confirm('Apakah anda yakin akan menghapus komentar ini?')" title="Anda menghapus komentar"><i class='fa fa-times'></i></a>
                        <?php
                      } else {
                        ?>
                        <a href="" class='btn btn-box-tool' onclick="alert('Anda tidak diperkenankan menghapus komentar akun user lain!')" title="Anda menghapus komentar"><i class='fa fa-times'></i></a>
                        <?php
                      }
                    ?>
                  </span>
          ...
          <div class="box-footer">
            <form action="?page=komentar&aksi=simpan_komentar" method="POST">
