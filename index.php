...
<html>
  <head>
    ...
    <title>AL QURAN SMK SANGKURIANG 1 CIMAHI</title>
    ...
    <div class="wrapper">
      ...
      <footer class="main-footer">
        <div class="container">
          ...
          <strong>Copyright &copy; <?php echo date('Y');?> <a href="index.php">E-GALERI SMK SANGKURIANG 1 CIMAHI</a>.</strong> All rights reserved.
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
