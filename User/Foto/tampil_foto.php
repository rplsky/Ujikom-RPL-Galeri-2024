                    ...
                    <div class='box-header with-border'>
                        ...
                        <div class='box-tools'>
                            <?php
                               ...
                               if ($jmllike == 0) {
                                    ?>
                                    <a href="?page=foto&aksi=like_foto&id=<?php echo $data['fotoid'] ?>&status=like" class='btn btn-default btn-xs' title="Anda Menyukai Foto"><i class='fa fa-thumbs-o-up'> Like</i></a>
                                    <?php
                               } else {
                                    ?>
