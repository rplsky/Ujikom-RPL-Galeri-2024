<?php
	...
	$query_id = "SELECT * FROM tbl_album WHERE userid = '$user' AND albumid = '$albumid'";
    ...
    if ($jmldata==0) {
        $query = "INSERT INTO tbl_album (albumid, namaalbum, deskripsi, tanggaldibuat, userid) VALUES ('$albumid', '$nama_album', '$deskripsi', '$tanggal', '$user')";
